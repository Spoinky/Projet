...
public class AddOiseau extends JFrame implements ActionListener{
	...
	public AddOiseau(Menagerie maMenagerie){
		//Titre de la fenêtre
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider){
			Oiseau unOiseau = new Oiseau(espece, nom, nbpattes, vitesses, couleur);
	
			this.menagerie.arriver(unOiseau);
				
			/*panel.add(labelOk = new JLabel("L'animal a été ajouté avec succès."));
			panel.add(labelQEspece = new JLabel("Votre Oiseau est un " + espece + ".")); 
