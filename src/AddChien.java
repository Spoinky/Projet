...
public class AddChien extends JFrame implements ActionListener{
	...
	public AddChien(Menagerie maMenagerie){
		//Titre de la fenêtre
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnValider){
			Chien unChien = new Chien(espece, nom, nbpattes, vitesses, couleur);
	
			this.menagerie.arriver(unChien);
				
			/*panel.add(labelOk = new JLabel("L'animal a été ajouté avec succès."));
			panel.add(labelQEspece = new JLabel("Votre Chien est un " + espece + ".")); 
